<?php /*a:1:{s:34:"../Theme/adminsys/article/add.html";i:1540351774;}*/ ?>
					...
					<div class="tab-content">
						...
						<div id="home" class="tab-pane active">
							<div class="form-group"><label class="col-sm-2 control-label no-padding-right" for="form-field-1"><i>*</i>标题： </label>
								<div class="col-sm-8"><input type="text" value="" name="title" class="col-xs-10 "></div>
							</div>
							<div class="form-group"><label class="col-sm-2 control-label no-padding-right" for="form-field-1"><i>*</i>分类： </label>
								<div class="col-sm-8">
									<select name='type' class="col-xs-10 " style="margin-left:10px ">
										...
										<?php if(is_array($article_type) || $article_type instanceof \think\Collection || $article_type instanceof \think\Paginator): $i = 0; $__LIST__ = $article_type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
											<option value="<?php echo htmlentities($v['type_id']); ?>" <?php if($type==$v['type_id']): ?>selected<?php endif; ?>><?php echo htmlentities($v['type_name']); ?></option>
							...
							<div class="form-group"><label class="col-sm-2 control-label no-padding-right" for="form-field-1"><i>*</i>内容： </label>
								<div class="col-sm-8">
									<textarea class="col-xs-10" id="editor" style="height: 400px" name="body"></textarea>
							...
							<?php if($type==2): ?>
								<div class="form-group"><label class="col-sm-2 control-label no-padding-right" for="form-field-1"><i></i>图1： </label>
									<div class="col-sm-8">
										<label>
					                        <img src="" width="50" height="50" id="img_thumb1" onerror="this.src='/static/admin/images/image.png'">
					                        <input name="listimg[]" type="hidden" id="listimg1" value="">
					                    </label>
								...
								<div class="form-group"><label class="col-sm-2 control-label no-padding-right" for="form-field-1"><i></i>图2： </label>
									<div class="col-sm-8">
										<label>
					                        <img src="" width="50" height="50" id="img_thumb2" onerror="this.src='/static/admin/images/image.png'">
					                        <input name="listimg[]" type="hidden" id="listimg2" value="">
					                    </label>
