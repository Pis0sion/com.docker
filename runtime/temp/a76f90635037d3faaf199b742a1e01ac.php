<?php /*a:1:{s:32:"../Theme/adminsys/rate/edit.html";i:1540351774;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		...
		<div class="add_menber" id="add_menber_style" >
			<form id="form" name="user-form" style="padding-top:2% ">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input value="<?php echo htmlentities($list['rate_rate']); ?>" id="rate" name="rate" type="text" class="form-control" required/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label no-padding-right" for=""><i>*</i>结算费用： </label>
					<div class="col-sm-8">
						<input value="<?php echo htmlentities($list['rate_close_rate']); ?>" id="close_rate" name="close_rate" type="text" class="form-control" required/>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-8">
						<select name="type" class="form-control" style="margin-left: 10px;">
							...
							<option value="1" <?php if($list['rate_type']==1): ?>selected<?php endif; ?>>还款</option>
							<option value="2" <?php if($list['rate_type']==2): ?>selected<?php endif; ?>>收款</option>
						</select>
					</div>
				</div>
				<div class="form-group">
