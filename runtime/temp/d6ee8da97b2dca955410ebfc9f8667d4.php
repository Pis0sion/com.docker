<?php /*a:1:{s:34:"../Theme/adminsys/issue/index.html";i:1544080062;}*/ ?>
							...
							<tbody>
								<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
									<tr>
										...
										<td><?php echo htmlentities($v['issue_id']); ?></td>
										<td><?php echo htmlentities($v['type_title']); ?></td>
										<td><?php echo htmlentities($v['issue_title']); ?></td>
										<td><?php echo htmlentities($v['issue_reply']); ?></td>
										<td><?php echo htmlentities(date('Y-m-d H:i:s',!is_numeric($v['issue_time'])? strtotime($v['issue_time']) : $v['issue_time'])); ?></td>
										<td>
											<?php if($v['issue_hot']==1): ?>
												是
											<?php else: ?>
												否
											<?php endif; ?>
										...
										<td class="td-manage">
											<div><a title="编辑" href="javascript:;" onclick="edit('<?php echo htmlentities($v['issue_id']); ?>')" class="btn btn-xs btn-success">编辑</a></div>
										</td>
									</tr>
