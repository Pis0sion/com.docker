<?php /*a:1:{s:33:"../Theme/adminsys/rate/index.html";i:1540351774;}*/ ?>
							...
							<tbody>
								<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
									<tr>
										...
										<td><?php echo htmlentities(getUserType($v['rate_type_id'])); ?></td>
										<td><?php if($v['rate_type']==1): ?>还款<?php else: ?>收款<?php endif; ?></td>
										...
										<td class="td-manage">
											...
											<a title="删除" href="javascript:;"  data-url="<?php echo Url('delete'); ?>?id=<?php echo htmlentities($v['rate_id']); ?>" data-confirm="确定删除吗？数据不可逆的" class="link-confirm btn btn-xs btn-danger">删除</a>
										</td>
									</tr>
