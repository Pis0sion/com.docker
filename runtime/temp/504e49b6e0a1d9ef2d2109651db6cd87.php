<?php /*a:1:{s:40:"../Theme/adminsys/articletype/index.html";i:1540351774;}*/ ?>
				...
				<div class="d_Confirm_Order_style">
					<div class="search_style">
						...
						<ul class="search_content clearfix">
							<li><label class="l_f">分类名称</label><input name="keywords" id="keywords" type="text" class="text_add" placeholder="输入分类名称" style=" width:400px" /></li>
						...
						<div><a title="添加分类" href="javascript:;" onclick="add()" class="btn btn-xs btn-success">添加分类</a></div>
					</div>
					<!---->
