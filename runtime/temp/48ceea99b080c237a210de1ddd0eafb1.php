<?php /*a:1:{s:35:"../Theme/adminsys/usertype/add.html";i:1543901238;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		...
		<div class="add_menber" id="add_menber_style" >
			<form id="user-form" name="user-form" style="padding-top:2% ">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input id="type_fee" name="type_fee" type="text" class="form-control"/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label no-padding-right" for="form-field-1"><i></i>推广用户数量： </label>
					<div class="col-sm-8">
						<input id="type_free_count" name="type_free_count" type="text"  class="form-control"/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label no-padding-right" for="form-field-1"><i></i>最低还款金额： </label>
					<div class="col-sm-8">
						<input id="type_free_amount" name="type_free_amount" type="text"  class="form-control"/>
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input id="type_sort" name="type_sort" type="text"  class="form-control"/>
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<button id="sub_btn" onclick="saveSubmit();" class="btn btn-primary radius" type="button"><i class="fa fa-save "></i>&nbsp;保存</button>
					</div>
				</div>
			</form>
		</div>
