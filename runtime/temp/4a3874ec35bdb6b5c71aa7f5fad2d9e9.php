<?php /*a:1:{s:39:"../Theme/adminsys/paymentmcc/index.html";i:1545457817;}*/ ?>
							...
							<tbody>
								<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
									<tr>
										...
										<td><?php echo htmlentities($v['mcc_id']); ?></td>
										<td><?php echo htmlentities($v['mcc_mcc']); ?></td>
										<td><?php echo htmlentities($v['mcc_title']); ?></td>
										<td class="td-manage">
											<a title="编辑" href="javascript:;" onclick="edit('<?php echo htmlentities($v['mcc_id']); ?>')" class="btn btn-xs btn-success">编辑</a>
											<a href="javascript:;" title="删除" data-url="<?php echo Url('del'); ?>?id=<?php echo htmlentities($v['mcc_id']); ?>" data-confirm="您确认要删除吗？"  class="link-confirm btn btn-xs btn-danger">删除</a>
										</td>
									</tr>
